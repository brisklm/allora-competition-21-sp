...
SELECTED_FEATURES = ['sign_log_return_lag1_BTCUSDT', 'momentum_BTCUSDT', 'rsi_BTCUSDT', 'volatility_BTCUSDT', 'volatility_ETHUSDT', 'close_BTCUSDT_lag1', 'close_ETHUSDT_lag1', 'hour_of_day']
